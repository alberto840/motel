...
@Component({
  selector: 'app-crear-ocuparcuarto-dialog',
  templateUrl: './crear-ocuparcuarto-dialog.component.html',
  styleUrls: ['./crear-ocuparcuarto-dialog.component.scss']
})
export class CrearOcuparcuartoDialogComponent {
